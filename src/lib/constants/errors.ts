export const API_ERRORS = {
  ...
  FAILED_TO_CREATE_RESTAURANT_REQUEST: 'Failed to create restaurant request',
  FAILED_TO_FETCH_RESTAURANT_REQUESTS: 'Failed to fetch restaurant requests',
  FAILED_TO_UPDATE_REQUEST: 'Failed to update restaurant request',
