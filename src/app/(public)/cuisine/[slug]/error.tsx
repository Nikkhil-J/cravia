...
export default function CuisineError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="mx-auto max-w-md px-6 py-20 text-center">
      <div className="text-5xl">😕</div>
      <h2 className="mt-4 font-display text-xl font-bold text-heading">{CLIENT_ERRORS.SOMETHING_WENT_WRONG}</h2>
      <p className="mt-2 text-sm text-text-secondary">We couldn&apos;t load this cuisine.</p>
